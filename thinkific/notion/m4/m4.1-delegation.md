...
*Answer: D — Because it is just a tool call, the main agent can invoke several subagents in parallel.*
...
*Answer: C — A subagent runs in an isolated context. Only the result crosses the boundary.*
