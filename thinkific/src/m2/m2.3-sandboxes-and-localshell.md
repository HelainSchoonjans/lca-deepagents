...
Complete the **Quiz** and **Labs** above, then continue to the next lesson on the interpreter and how the agent writes and executes code directly in the main loop.
