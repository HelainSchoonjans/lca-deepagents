...
<svg viewBox="0 0 720 190" width="100%" role="img" aria-label="LLM calls filesystem tools (read_file, write_file, ls, grep, glob) which pass through a Backend to storage." xmlns="http://www.w3.org/2000/svg" font-family="'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif">
