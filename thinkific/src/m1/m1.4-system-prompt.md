...
Complete the **Quiz**, **Lab 1**, and **Lab 2** above, then continue to the next lesson on **tools**: how to extend the agent with custom Python functions and how the Tool Node executes them.
