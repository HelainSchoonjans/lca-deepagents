...
You've now covered running a deep agent, choosing models, writing system prompts, building custom tools, connecting MCP servers, managing messages/threads/checkpointers, and human-in-the-loop approval.

<div style="background:#E3F9F0;border:1.5px solid #34D399;border-radius:12px;padding:1rem 1.25rem;color:#0B4A34;">This homework combines everything you just learned into a fun personality quiz that figures out what kind of developer/builder you are, then matches you to a real LangChain product based on that style.</div>
...
<div style="background:#CCE9FF;border:1.5px solid #7FC8FF;border-radius:12px;padding:1rem 1.25rem;color:#030710;">Got a card you like? Screenshot your terminal, tag @LangChain on X or LinkedIn, and show us what your judge came up with. We want to see what you build!</div>
